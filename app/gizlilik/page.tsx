export default function PrivacyPage() {
  return <main className="legal shell">
    ...
    <p>AgentAxis Labs, yalnız hizmet talebinizi değerlendirmek ve sizinle iletişim kurmak için paylaştığınız bilgileri kullanır.</p>
    <h2>Toplanan bilgiler</h2><p>İşletme adı, faaliyet alanı, isteğe bağlı web sitesi veya Google Haritalar bağlantısı ve e-posta yoluyla ilettiğiniz iletişim bilgileri.</p>
