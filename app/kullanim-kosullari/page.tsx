export default function TermsPage() {
  return <main className="legal shell">
    ...
    <h2>10 günlük Jarvis denemesi</h2><p>Jarvis denemesi her işletmeye bir kez sunulur ve otomatik olarak ücretli hizmete dönüşmez. Kapsam görüşme sonrası yazılı olarak netleştirilir. Harici uygulama, reklam ve iletişim sağlayıcısı maliyetleri ayrıca açıklanır.</p>
