...
export default function TermsPage() {
  return <main className="legal shell">
    ...
    <h2>7 günlük Akıllı İşletme Asistanı denemesi</h2><p>Akıllı İşletme Asistanı denemesi her işletmeye bir kez sunulur ve otomatik olarak ücretli hizmete dönüşmez. Yedi günlük süre, gerekli bağlantılar test edilip çalıştığı doğrulandıktan sonra başlar. Kapsam görüşme sonrası yazılı olarak netleştirilir. Harici uygulama, reklam ve iletişim sağlayıcısı maliyetleri ayrıca açıklanır.</p>
